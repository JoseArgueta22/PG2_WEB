...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nueva_contrasena = password_hash($_POST['nueva_contrasena'], PASSWORD_DEFAULT); // Hashear nueva contraseña
    ...
    if ($result && mysqli_num_rows($result) == 1) {
        ...
        // Verificar la respuesta de seguridad (insensible a mayúsculas/minúsculas)
